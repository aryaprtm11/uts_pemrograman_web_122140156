  ...
  return (
    ...
    >
      ...
      >
        ...
        {cartItems.length === 0 ? (
          <p className="text-gray-500">Keranjang kosong, silahkan pilih menu terlebih dahulu</p>
        ) : (
          <>
            <ul className="space-y-4 mb-6">
              {cartItems.map((item, index) => (
                <li key={index} className="border-b pb-2">
                  ...
                  <div className="text-sm text-gray-600">Rp {Number(item.price).toLocaleString("id-ID", { minimumFractionDigits: 2 })}</div>
                </li>
              ))}
            </ul>
